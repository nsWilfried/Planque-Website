<template>
  <div class="w-full h-auto">
    ...
    <!-- banner informations -->
    <div class="w-full relative bg-green- flex justify-center items-center" style="height: 250px">
      <div class="bg-white shadow-lg h-full flex" style="
          width: 1320px;
          position: absolute;
          top: -30%;
          z-index: 10000;
        ...
        <!-- information urgente -->
        <div class="flex justify-center items-center w-2/3 shadow-inner text-white p-5" style="background: #1c2e5e">
