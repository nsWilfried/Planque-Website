<template>
  <div class="w-full h-auto">
    <!-- banner -->
    <div class="main w-full h-screen bg-blue-600 flex flex-col justify-center items-center relative">
      <!-- swiper elements -->
      <div class="swiper w-full h-full">
        ...
        <!-- navigation -->
        <div class="swiper-button-prev bg-white ml-10 p-8 swiper_content_zindex"></div>
        <div class="swiper-button-next bg-white p-8 mr-10 swiper_content_zindex"></div>
      </div>
      <!-- swiper elements -->
    </div>

    <!-- banner informations -->
    <div class="w-full relative banner__informations bg-green- flex justify-center items-center">
      <div class="bg-white shadow-lg h-full flex banner__informations__content">
        ...
        <div class="flex banner__info justify-center items-center bg-blue- w-1/3 p-6">
          <div class="grid grid-rows-3">
            ...
            <div class="flex items-center bg-red-">
              <button class="w-32 bg-transparent border-white border border-3 bg-white text-black p-3">
                En lire plus
              </button>
            </div>
          </div>
        ...
        <!-- information urgente -->
        <div class="flex banner__info justify-center items-center w-2/3 shadow-inner text-white p-5"
    ...
    <div
      ...
      <div class="bg-gradient-to-r from-red- to-transparent">
        <section class="text-gray-600 body-font">
          <div class="container introduction__image px-5 py-24 mx-auto flex flex-wrap">
            <div class=" mx-auto">
      ...
      <div class="rounded border-gray- flex justify-center items-center h-full">
        <div class="introduction__stepper">
          <ol class="relative border-l border-gray-200 dark:border-gray-700">
            <li v-for="element of presentation" :key="element.name" class="mb-10 ml-6">
              <span
    ...
    <section class="bg-indigo-700  w-full">
      <section class="mx-auto container bg-indigo-700  bg- dark:bg-gray-900 pt-16">
          ...
          <div class="grid gap-5 lg:grid-cols-3 sm:max-w-sm sm:mx-auto lg:max-w-full">
            <div v-for="(post, index) in posts" :key="index"
              ...
              <a href="/" aria-label="Article"><img
                  :src="post.image.image.asset._ref"
    ...
    <div class="w-full h-auto flex bg-green-">
      <figure
        ...
        <svg aria-hidden="true" class="mx-auto mb-3 w-12 h-12 text-gray-400 dark:text-gray-600" viewBox="0 0 24 27"
  ...
  data() {
    return {
      presentation: [
        {
          title: "Objectif",
          description:"Une formation intégrale et équilibrée de la jeunesse en vue d'une Afrique épanouie",
          icon: "",
        },
        {
          title: "Identité",
          description:"Un collège catholique d'enseignement général ouvert parles Soeurs Missionnaires de Notre Dame des Apôtres",
          icon: "",
        },
        {
          title: "Devise",
          description:"RESPECT-TRAVAIL SERIEUX-REUSSITE AVEC MARIE MERE DE JESUS",
          icon: "",
        },
      ],
    };
