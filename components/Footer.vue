    ...
    <div class="w-full flex justify-center bg-red- items-center h-auto">
        ...
        <footer class="p-4 footer bg-white sm:p-6 dark:bg-gray-900">
                        ...
                        <ul class="text-gray-600 dark:text-gray-400">
                            <li class="mb-4">
                                <a href="https://github.com/themesberg/flowbite"
                                    class="hover:underline ">collegepereplanque@gmail.com</a>
                            </li>
                            <li class="mb-4">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <router-link to="/"
                        class="hover:underline">CPAP™</router-link>. Tout drois réservés.
                </span>
